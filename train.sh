...
SAVE_PATH="${SAVE_PATH:-/home/vaia/ResGS/output/multi_res_scale_opencv_7_5_2500_6000_until_16000_3dgs_tb_full_eval_all}"
...
docker run -it --rm \
  ...
  bash -lc "
      ...
      python -u /app/script.py \
        ...
        --save_path /app/output/multi_res_scale_opencv_7_5_2500_6000_until_16000_3dgs_tb_full_eval_all ;
